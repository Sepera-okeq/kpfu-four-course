"""
Система логирования для защищенного чата.

Модуль реализует единую систему логирования для всех компонентов приложения:
1. Основные возможности:
   - Запись логов в файлы
   - Вывод в консоль
   - Различные уровни логирования (INFO, ERROR, WARNING)
